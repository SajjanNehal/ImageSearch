        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><h2 class="text-center text-primary">Edit Image</h2></div>
                    <div class="panel-body">
                        ...
                        @endif
                        {{ Form::model($image, array('url' =>'/images/'.$image->id, 'method' => 'PUT','enctype' => 'multipart/form-data', 'files' => true)) }}
                        {{ csrf_field() }}
                        <div class="col-sm-12">
                            <div class="form-group">
                                <img src="{{ $image->image == ''? url('img/no-image.png'):url('img/upload/'.$image->image) }}" alt="" class="img-stu center-block">
                        ...
                        <div class="form-group col-sm-12 text-center">
                            <button type="submit" class="btn btn-success">Update Image <i class="fa fa-upload"></i></button>
                        </div>
                        {{ Form::close() }}
